...
int progressCallback(void *p,
                     ...
                     curl_off_t ulnow)
{
    struct FTPCurlManager::CustomProgress *progress = (struct FTPCurlManager::CustomProgress *)p;
...
int FTPCurlManager::FtpUpload(const char *remote_file_path,
                              ...
                              long tries)
{
    ...
    struct FTPCurlManager::CustomProgress prog;
